				...
				<div class="card">
					<div class="card-header">
                        <div class="row">
                            <div class="col-9"></div>
                            <div class="col-3">
                                <button type="button" class="btn btn-block bg-gradient-warning btn-sm">Add Members</button>
                            </div>
                        </div>
                    </div>
					<div class="card-body">
...
$(function () {
    ...
    $('#addBlog').on('click', function(){
        ...
        $('#addModal').find('#confirmPassword').val("");
        $('#addModal').modal('show');
...
function edit(id){
    $.post('php/getUser.php', {userID: id}, function(data){
        ...
        if(obj.status === 'success'){
            ...
            $('#addModal').find('#password').val(obj.message.name);
            $('#addModal').find('#confirmPassword').val(obj.message.role_code);
            $('#addModal').modal('show');
